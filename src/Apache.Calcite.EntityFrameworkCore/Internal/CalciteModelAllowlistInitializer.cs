...
/// the property into a static field the first time its configuration class initializes. Loading this assembly is what
/// <c>UseCalcite</c> does, which necessarily precedes opening a connection.
/// </para>
/// </remarks>
